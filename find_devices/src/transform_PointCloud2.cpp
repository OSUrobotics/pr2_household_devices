...
#include <find_devices/TransformPointCloud2.h>
...
bool transform_cloud(find_devices::TransformPointCloud2::Request &request, find_devices::TransformPointCloud2::Response &response) {
